...
// const useChamberLogNodeStore = create<ChamberLogNode>((set) => ({
//   state: {
//     is_available: false,
//     is_running: false,
//     is_streaming: false,
...
//     ...state,
//     state: { ...state.state, is_streaming: isStreaming }
//   })),

//   setState: (newState: Partial<ChamberLogNodeState>) => set((prevState) => ({
//     ...prevState,
